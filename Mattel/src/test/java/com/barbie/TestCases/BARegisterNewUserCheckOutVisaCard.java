...
import com.barbie.Pages.PaymentToCompleteOrderForRegisterUser;
import com.barbie.Pages.RegistrationForm;

public class BARegisterNewUserCheckOutVisaCard extends TestBaseBA {
	...
	public void registerUser() throws Exception {
		startTest("BARegisterUser")
		.assignCategory("smoke")
		.setDescription("Register new account");
		
		String url = configStringBuilder("BAURL","BALogonPath");
